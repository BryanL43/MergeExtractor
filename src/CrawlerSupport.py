...
class CrawlerSupport:
    ...
    def process_single_job(
        ...
        company_names = [company_A, company_B];
        documents = Processor.getDocuments(source_links, company_names, max_num_of_threads, rate_limiter_resources);
        ...
        if not documents and any("-" in name for name in company_names):
            ...
            documents = Processor.getDocuments(source_links, modified_names, max_num_of_threads, rate_limiter_resources);
