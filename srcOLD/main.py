...
# from AnalysisAssistant import ContextAssistant
...
def main():
    ...
    # classifier = InitiatorClassifier(companyAList, companyBList, analystAssistant, threadCount=5);
    # # cognition.findInitiator(startIndex=0, endIndex=10); # Index literal; 0 is 0
    # classifier.findInitiator(index=3);
